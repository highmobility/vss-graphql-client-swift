...
extension FilesGenerator {
    ...
    func getValidPropertyName(forName name: String) -> String {
        func createTemplate(invalidName: String) -> String {
            "<#invalid property name '\(invalidName)' - provide a new name" +
                "#>"
        }
        ...
        if name == "class" {
            ...
            invalidNameTemplate = "`type`"
        }
        else if name == "switch" {
            invalidNameTemplate = "`switch`"
        }
        else if name == "extension" {
            invalidNameTemplate = "`extension`"
        }
        else if name == "struct" {
    ...
    private var reservedKeywords: [String] {
