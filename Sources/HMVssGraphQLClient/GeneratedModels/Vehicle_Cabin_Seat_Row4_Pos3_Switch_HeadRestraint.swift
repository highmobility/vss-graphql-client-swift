...
final class Vehicle_Cabin_Seat_Row4_Pos3_Switch_HeadRestraint: Object, ObjectSchema {
...
public class Cabin_Seat_Row4_Pos3_Switch_HeadRestraint: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row4_Pos3_Switch_HeadRestraint
