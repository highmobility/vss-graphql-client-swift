...
public final class CabinSeatRow1Pos4: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow1Pos4Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow1Pos4Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow1Pos4HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow1Pos4Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow1Pos4SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow1Pos4Switch?, NoArguments>("switch")
