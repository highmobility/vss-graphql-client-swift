...
final class Vehicle_Cabin_Seat_Row2_Pos3_SideBolster: Object, ObjectSchema {
...
public class Cabin_Seat_Row2_Pos3_SideBolster: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row2_Pos3_SideBolster
