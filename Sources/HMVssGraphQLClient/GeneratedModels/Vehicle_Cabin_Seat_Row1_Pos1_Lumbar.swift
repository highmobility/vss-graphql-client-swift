...
final class Vehicle_Cabin_Seat_Row1_Pos1_Lumbar: Object, ObjectSchema {
...
public class Cabin_Seat_Row1_Pos1_Lumbar: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row1_Pos1_Lumbar
