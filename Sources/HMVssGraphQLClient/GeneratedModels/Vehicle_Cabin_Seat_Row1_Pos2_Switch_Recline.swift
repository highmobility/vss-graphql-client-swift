...
final class Vehicle_Cabin_Seat_Row1_Pos2_Switch_Recline: Object, ObjectSchema {
...
public class Cabin_Seat_Row1_Pos2_Switch_Recline: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row1_Pos2_Switch_Recline
