...
final class Vehicle_Cabin_Seat_Row3_Pos4_Airbag: Object, ObjectSchema {
...
public class Cabin_Seat_Row3_Pos4_Airbag: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row3_Pos4_Airbag
