...
final class Vehicle_Cabin_Door_Row2_Right_Shade: Object, ObjectSchema {
    ...
    */
    ...
    Switch controlling sliding action such as window, sunroof, or blind.
    */
    var `switch` = Field<Vehicle_Cabin_Door_Row2_Right_Shade_Switch_Enum?, NoArguments>("switch")

}


public class Cabin_Door_Row2_Right_Shade: Model {

    typealias PartialType = Vehicle_Cabin_Door_Row2_Right_Shade

    public let position: Int?
    public let `switch`: Cabin_Door_Row2_Right_Shade_Switch_Enum?
