...
final class Vehicle_Cabin_RearShade: Object, ObjectSchema {
    ...
    */
    ...
    Switch controlling sliding action such as window, sunroof, or blind.
    */
    var `switch` = Field<Vehicle_Cabin_RearShade_Switch_Enum?, NoArguments>("switch")

}


public class Cabin_RearShade: Model {

    typealias PartialType = Vehicle_Cabin_RearShade

    public let position: Int?
    public let `switch`: Cabin_RearShade_Switch_Enum?
