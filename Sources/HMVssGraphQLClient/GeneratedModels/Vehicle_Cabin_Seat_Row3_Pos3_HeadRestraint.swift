...
final class Vehicle_Cabin_Seat_Row3_Pos3_HeadRestraint: Object, ObjectSchema {
...
public class Cabin_Seat_Row3_Pos3_HeadRestraint: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row3_Pos3_HeadRestraint
