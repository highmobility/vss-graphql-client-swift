...
final class Vehicle_Cabin_Seat_Row2_Pos5_Cushion: Object, ObjectSchema {
...
public class Cabin_Seat_Row2_Pos5_Cushion: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row2_Pos5_Cushion
