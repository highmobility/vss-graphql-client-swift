...
final class Vehicle_Cabin_Seat_Row2_Pos2_HeadRestraint: Object, ObjectSchema {
...
public class Cabin_Seat_Row2_Pos2_HeadRestraint: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row2_Pos2_HeadRestraint
