...
final class Vehicle_Cabin_Seat_Row4_Pos4_Switch_Recline: Object, ObjectSchema {
...
public class Cabin_Seat_Row4_Pos4_Switch_Recline: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row4_Pos4_Switch_Recline
