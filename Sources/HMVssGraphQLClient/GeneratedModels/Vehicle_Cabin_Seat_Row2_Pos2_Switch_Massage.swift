...
final class Vehicle_Cabin_Seat_Row2_Pos2_Switch_Massage: Object, ObjectSchema {
...
public class Cabin_Seat_Row2_Pos2_Switch_Massage: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row2_Pos2_Switch_Massage
