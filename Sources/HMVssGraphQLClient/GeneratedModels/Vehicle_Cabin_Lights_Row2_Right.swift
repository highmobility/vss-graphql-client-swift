...
final class Vehicle_Cabin_Lights_Row2_Right: Object, ObjectSchema {
...
public class Cabin_Lights_Row2_Right: Model {

    typealias PartialType = Vehicle_Cabin_Lights_Row2_Right
