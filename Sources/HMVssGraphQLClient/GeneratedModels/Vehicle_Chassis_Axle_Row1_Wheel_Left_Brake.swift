...
final class Vehicle_Chassis_Axle_Row1_Wheel_Left_Brake: Object, ObjectSchema {
...
public class Chassis_Axle_Row1_Wheel_Left_Brake: Model {

    typealias PartialType = Vehicle_Chassis_Axle_Row1_Wheel_Left_Brake
