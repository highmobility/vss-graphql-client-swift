...
final class Vehicle_Cabin_Seat_Row2_Pos4_Switch_Massage: Object, ObjectSchema {
...
public class Cabin_Seat_Row2_Pos4_Switch_Massage: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row2_Pos4_Switch_Massage
