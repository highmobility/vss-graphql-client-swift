...
public class Body_Mirrors_Left: Model {

    typealias PartialType = Vehicle_Body_Mirrors_Left

    public let heating: Body_Mirrors_Left_Heating?
    public let pan: Int?
    public let tilt: Int?

    required init?(partial: Partial<PartialType?>) {
        heating = Body_Mirrors_Left_Heating(partial: partial.heating)
        pan = partial.pan ?? nil
