...
final class Vehicle_Cabin_Seat_Row3_Pos3_Switch_Lumbar: Object, ObjectSchema {
...
public class Cabin_Seat_Row3_Pos3_Switch_Lumbar: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row3_Pos3_Switch_Lumbar
