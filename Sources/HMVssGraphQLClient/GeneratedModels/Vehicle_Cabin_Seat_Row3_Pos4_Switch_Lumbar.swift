...
final class Vehicle_Cabin_Seat_Row3_Pos4_Switch_Lumbar: Object, ObjectSchema {
...
public class Cabin_Seat_Row3_Pos4_Switch_Lumbar: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row3_Pos4_Switch_Lumbar
