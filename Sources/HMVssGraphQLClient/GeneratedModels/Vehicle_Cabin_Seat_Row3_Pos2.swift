...
public final class CabinSeatRow3Pos2: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow3Pos2Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow3Pos2Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow3Pos2HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow3Pos2Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow3Pos2SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow3Pos2Switch?, NoArguments>("switch")
