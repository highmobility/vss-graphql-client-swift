...
final class Vehicle_Cabin_Door_Row3_Right_Window: Object, ObjectSchema {
    ...
    */
    ...
    Switch controlling sliding action such as window, sunroof, or blind.
    */
    var `switch` = Field<Vehicle_Cabin_Door_Row3_Right_Window_Switch_Enum?, NoArguments>("switch")

}


public class Cabin_Door_Row3_Right_Window: Model {

    typealias PartialType = Vehicle_Cabin_Door_Row3_Right_Window

    public let position: Int?
    public let `switch`: Cabin_Door_Row3_Right_Window_Switch_Enum?
