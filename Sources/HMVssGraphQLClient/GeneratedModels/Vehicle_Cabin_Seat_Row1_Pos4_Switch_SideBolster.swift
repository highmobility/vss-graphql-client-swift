...
final class Vehicle_Cabin_Seat_Row1_Pos4_Switch_SideBolster: Object, ObjectSchema {
...
public class Cabin_Seat_Row1_Pos4_Switch_SideBolster: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row1_Pos4_Switch_SideBolster
