...
public final class CabinSeatRow1Pos1: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow1Pos1Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow1Pos1Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow1Pos1HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow1Pos1Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow1Pos1SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow1Pos1Switch?, NoArguments>("switch")
