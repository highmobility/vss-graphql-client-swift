...
final class Vehicle_Cabin_HVAC_Row2_Left: Object, ObjectSchema {

    /**
    Direction of airstream
    */
    var airDistribution = Field<Vehicle_Cabin_HVAC_Row2_Left_AirDistribution_Enum?, NoArguments>("airDistribution")
...
public class Cabin_HVAC_Row2_Left: Model {

    typealias PartialType = Vehicle_Cabin_HVAC_Row2_Left

    public let airDistribution: Cabin_HVAC_Row2_Left_AirDistribution_Enum?
