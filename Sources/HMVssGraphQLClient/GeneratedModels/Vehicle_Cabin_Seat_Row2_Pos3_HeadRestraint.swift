...
final class Vehicle_Cabin_Seat_Row2_Pos3_HeadRestraint: Object, ObjectSchema {
...
public class Cabin_Seat_Row2_Pos3_HeadRestraint: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row2_Pos3_HeadRestraint
