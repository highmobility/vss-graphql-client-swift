...
public final class CabinDoorRow4Left: Object, ObjectSchema {
    ...
    var shade = Field<CabinDoorRow4LeftShade?, NoArguments>("shade")

    var window = Field<CabinDoorRow4LeftWindow?, NoArguments>("window")
