...
final class Vehicle_Body_Windshield_Front_Heating: Object, ObjectSchema {
...
public class Body_Windshield_Front_Heating: Model {

    typealias PartialType = Vehicle_Body_Windshield_Front_Heating
