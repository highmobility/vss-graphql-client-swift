...
public final class CabinSeatRow4Pos3: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow4Pos3Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow4Pos3Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow4Pos3HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow4Pos3Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow4Pos3SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow4Pos3Switch?, NoArguments>("switch")
