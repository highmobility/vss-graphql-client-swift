...
public class Cabin_RearviewMirror: Model {

    typealias PartialType = Vehicle_Cabin_RearviewMirror

    public let dimmingLevel: Int?

    required init?(partial: Partial<PartialType?>) {
        dimmingLevel = partial.dimmingLevel ?? nil
    }
}
