...
public final class CabinDoorRow4Right: Object, ObjectSchema {
    ...
    var shade = Field<CabinDoorRow4RightShade?, NoArguments>("shade")

    var window = Field<CabinDoorRow4RightWindow?, NoArguments>("window")
