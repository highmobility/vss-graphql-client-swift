...
final class Vehicle_Cabin_Seat_Row4_Pos1_Airbag: Object, ObjectSchema {
...
public class Cabin_Seat_Row4_Pos1_Airbag: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row4_Pos1_Airbag
