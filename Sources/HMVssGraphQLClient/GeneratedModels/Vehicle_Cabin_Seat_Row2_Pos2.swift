...
public final class CabinSeatRow2Pos2: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow2Pos2Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow2Pos2Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow2Pos2HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow2Pos2Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow2Pos2SideBolster?, NoArguments>("sideBolster")
