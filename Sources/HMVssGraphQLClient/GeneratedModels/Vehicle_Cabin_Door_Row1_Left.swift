...
public final class CabinDoorRow1Left: Object, ObjectSchema {
    ...
    var shade = Field<CabinDoorRow1LeftShade?, NoArguments>("shade")

    var window = Field<CabinDoorRow1LeftWindow?, NoArguments>("window")
