...
final class Vehicle_Cabin_HVAC_Row4_Right: Object, ObjectSchema {

    /**
    Direction of airstream
    */
    var airDistribution = Field<Vehicle_Cabin_HVAC_Row4_Right_AirDistribution_Enum?, NoArguments>("airDistribution")
...
public class Cabin_HVAC_Row4_Right: Model {

    typealias PartialType = Vehicle_Cabin_HVAC_Row4_Right

    public let airDistribution: Cabin_HVAC_Row4_Right_AirDistribution_Enum?
