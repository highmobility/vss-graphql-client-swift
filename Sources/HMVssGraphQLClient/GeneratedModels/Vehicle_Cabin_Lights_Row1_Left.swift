...
final class Vehicle_Cabin_Lights_Row1_Left: Object, ObjectSchema {
...
public class Cabin_Lights_Row1_Left: Model {

    typealias PartialType = Vehicle_Cabin_Lights_Row1_Left
