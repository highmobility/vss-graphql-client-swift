...
final class Vehicle_Cabin_Door_Row2_Left: Object, ObjectSchema {
    ...
    */
    ...
    var shade = Field<Vehicle_Cabin_Door_Row2_Left_Shade?, NoArguments>("shade")

    var window = Field<Vehicle_Cabin_Door_Row2_Left_Window?, NoArguments>("window")

}


public class Cabin_Door_Row2_Left: Model {

    typealias PartialType = Vehicle_Cabin_Door_Row2_Left

    public let isChildLockActive: Bool?
    public let isLocked: Bool?
    public let isOpen: Bool?
    public let shade: Cabin_Door_Row2_Left_Shade?
    public let window: Cabin_Door_Row2_Left_Window?
    ...
    required init?(partial: Partial<PartialType?>) {
        ...
        shade = Cabin_Door_Row2_Left_Shade(partial: partial.shade)
        window = Cabin_Door_Row2_Left_Window(partial: partial.window)
    }
}
