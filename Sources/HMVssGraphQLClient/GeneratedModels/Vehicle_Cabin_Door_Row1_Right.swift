...
final class Vehicle_Cabin_Door_Row1_Right: Object, ObjectSchema {
    ...
    */
    ...
    var shade = Field<Vehicle_Cabin_Door_Row1_Right_Shade?, NoArguments>("shade")

    var window = Field<Vehicle_Cabin_Door_Row1_Right_Window?, NoArguments>("window")

}


public class Cabin_Door_Row1_Right: Model {

    typealias PartialType = Vehicle_Cabin_Door_Row1_Right

    public let isChildLockActive: Bool?
    public let isLocked: Bool?
    public let isOpen: Bool?
    public let shade: Cabin_Door_Row1_Right_Shade?
    public let window: Cabin_Door_Row1_Right_Window?
    ...
    required init?(partial: Partial<PartialType?>) {
        ...
        shade = Cabin_Door_Row1_Right_Shade(partial: partial.shade)
        window = Cabin_Door_Row1_Right_Window(partial: partial.window)
    }
}
