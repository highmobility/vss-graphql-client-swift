...
public final class CabinSeatRow2Pos3: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow2Pos3Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow2Pos3Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow2Pos3HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow2Pos3Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow2Pos3SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow2Pos3Switch?, NoArguments>("switch")
