...
public final class CabinSeatRow3Pos5: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow3Pos5Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow3Pos5Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow3Pos5HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow3Pos5Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow3Pos5SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow3Pos5Switch?, NoArguments>("switch")
