...
final class Vehicle_Cabin_Seat_Row2_Pos3_Airbag: Object, ObjectSchema {
...
public class Cabin_Seat_Row2_Pos3_Airbag: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row2_Pos3_Airbag
