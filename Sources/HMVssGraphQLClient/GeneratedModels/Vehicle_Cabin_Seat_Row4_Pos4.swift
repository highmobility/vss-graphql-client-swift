...
public final class CabinSeatRow4Pos4: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow4Pos4Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow4Pos4Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow4Pos4HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow4Pos4Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow4Pos4SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow4Pos4Switch?, NoArguments>("switch")
