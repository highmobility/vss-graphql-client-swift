...
final class Vehicle_Cabin_Seat_Row3_Pos2_Lumbar: Object, ObjectSchema {
...
public class Cabin_Seat_Row3_Pos2_Lumbar: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row3_Pos2_Lumbar
