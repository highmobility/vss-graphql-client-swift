...
final class Vehicle_Cabin_Seat_Row1_Pos1_Cushion: Object, ObjectSchema {
...
public class Cabin_Seat_Row1_Pos1_Cushion: Model {

    typealias PartialType = Vehicle_Cabin_Seat_Row1_Pos1_Cushion
