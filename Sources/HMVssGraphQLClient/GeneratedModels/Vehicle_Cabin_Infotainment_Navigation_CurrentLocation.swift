...
public class Cabin_Infotainment_Navigation_CurrentLocation: Model {

    typealias PartialType = Vehicle_Cabin_Infotainment_Navigation_CurrentLocation
    ...
    required init?(partial: Partial<PartialType?>) {
        accuracy = partial.accuracy ?? nil
        altitude = partial.altitude ?? nil
        heading = partial.heading ?? nil
