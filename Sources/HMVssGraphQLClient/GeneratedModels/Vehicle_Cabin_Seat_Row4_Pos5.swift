...
public final class CabinSeatRow4Pos5: Object, ObjectSchema {

    var airbag = Field<CabinSeatRow4Pos5Airbag?, NoArguments>("airbag")

    var cushion = Field<CabinSeatRow4Pos5Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    var headRestraint = Field<CabinSeatRow4Pos5HeadRestraint?, NoArguments>("headRestraint")
    ...
    var lumbar = Field<CabinSeatRow4Pos5Lumbar?, NoArguments>("lumbar")
    ...
    var sideBolster = Field<CabinSeatRow4Pos5SideBolster?, NoArguments>("sideBolster")

    var `switch` = Field<CabinSeatRow4Pos5Switch?, NoArguments>("switch")
