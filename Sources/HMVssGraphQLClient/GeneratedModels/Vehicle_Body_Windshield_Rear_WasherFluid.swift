...
final class Vehicle_Body_Windshield_Rear_WasherFluid: Object, ObjectSchema {
...
public class Body_Windshield_Rear_WasherFluid: Model {

    typealias PartialType = Vehicle_Body_Windshield_Rear_WasherFluid
