...
public class CabinSeatRow1Pos2: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow1Pos2Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow1Pos2Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow1Pos2HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow1Pos2Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow1Pos2SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow1Pos2Switch?, NoArguments>("switch")
