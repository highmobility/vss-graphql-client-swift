...
public class CabinSeatRow3Pos4: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow3Pos4Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow3Pos4Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow3Pos4HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow3Pos4Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow3Pos4SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow3Pos4Switch?, NoArguments>("switch")
