...
public class CabinSeatRow1Pos4: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow1Pos4Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow1Pos4Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow1Pos4HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow1Pos4Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow1Pos4SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow1Pos4Switch?, NoArguments>("switch")
