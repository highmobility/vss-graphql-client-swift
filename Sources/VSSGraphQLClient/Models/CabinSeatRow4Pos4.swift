...
public class CabinSeatRow4Pos4: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow4Pos4Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow4Pos4Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow4Pos4HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow4Pos4Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow4Pos4SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow4Pos4Switch?, NoArguments>("switch")
