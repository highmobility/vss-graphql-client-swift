...
public struct CabinSeatRow1Pos1Switch: GraphQLObjectType {
    ...
    public static var objects: [String : GraphQLObjectType.Type] {
        [
            "cushion" : CabinSeatRow1Pos1SwitchCushion.self,
            "headRestraint" : CabinSeatRow1Pos1SwitchHeadRestraint.self,
            "lumbar" : CabinSeatRow1Pos1SwitchLumbar.self,
            "massage" : CabinSeatRow1Pos1SwitchMassage.self,
            "recline" : CabinSeatRow1Pos1SwitchRecline.self,
            "sideBolster" : CabinSeatRow1Pos1SwitchSideBolster.self
        ]
    }
}