...
public class CabinDoorRow1Left: Object, ObjectSchema {
    ...
    public var shade = Field<CabinDoorRow1LeftShade?, NoArguments>("shade")

    public var window = Field<CabinDoorRow1LeftWindow?, NoArguments>("window")
