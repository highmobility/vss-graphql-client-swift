...
public class CabinSeatRow2Pos5: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow2Pos5Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow2Pos5Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow2Pos5HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow2Pos5Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow2Pos5SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow2Pos5Switch?, NoArguments>("switch")
