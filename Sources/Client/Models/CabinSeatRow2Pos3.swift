...
public class CabinSeatRow2Pos3: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow2Pos3Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow2Pos3Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow2Pos3HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow2Pos3Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow2Pos3SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow2Pos3Switch?, NoArguments>("switch")
