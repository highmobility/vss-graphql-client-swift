...
public class CabinSeatRow4Pos2: Object, ObjectSchema {
    ...
    public var airbag = Field<CabinSeatRow4Pos2Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow4Pos2Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow4Pos2HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow4Pos2Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow4Pos2SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow4Pos2Switch?, NoArguments>("switch")
