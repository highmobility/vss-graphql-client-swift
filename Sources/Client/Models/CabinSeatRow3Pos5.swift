...
public class CabinSeatRow3Pos5: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow3Pos5Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow3Pos5Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow3Pos5HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow3Pos5Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow3Pos5SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow3Pos5Switch?, NoArguments>("switch")
