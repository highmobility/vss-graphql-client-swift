...
public class CabinSeatRow3Pos1: Object, ObjectSchema {
    ...
    public var airbag = Field<CabinSeatRow3Pos1Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow3Pos1Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow3Pos1HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow3Pos1Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow3Pos1SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow3Pos1Switch?, NoArguments>("switch")
