...
public class CabinSeatRow1Pos5: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow1Pos5Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow1Pos5Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow1Pos5HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow1Pos5Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow1Pos5SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow1Pos5Switch?, NoArguments>("switch")
