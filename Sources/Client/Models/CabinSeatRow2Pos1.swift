...
public class CabinSeatRow2Pos1: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow2Pos1Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow2Pos1Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow2Pos1HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow2Pos1Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow2Pos1SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow2Pos1Switch?, NoArguments>("switch")
