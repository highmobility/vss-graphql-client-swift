...
public class CabinSeatRow1Pos1: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow1Pos1Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow1Pos1Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow1Pos1HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow1Pos1Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow1Pos1SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow1Pos1Switch?, NoArguments>("switch")
