...
public class CabinDoorRow1Right: Object, ObjectSchema {
    ...
    public var shade = Field<CabinDoorRow1RightShade?, NoArguments>("shade")

    public var window = Field<CabinDoorRow1RightWindow?, NoArguments>("window")
