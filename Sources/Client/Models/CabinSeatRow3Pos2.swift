...
public class CabinSeatRow3Pos2: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow3Pos2Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow3Pos2Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow3Pos2HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow3Pos2Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow3Pos2SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow3Pos2Switch?, NoArguments>("switch")
