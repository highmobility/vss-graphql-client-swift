...
public class CabinSeatRow4Pos5: Object, ObjectSchema {

    public var airbag = Field<CabinSeatRow4Pos5Airbag?, NoArguments>("airbag")

    public var cushion = Field<CabinSeatRow4Pos5Cushion?, NoArguments>("cushion")

    /// Does the seat have a passenger in it.
    public var hasPassenger = Field<Bool?, NoArguments>("hasPassenger")

    public var headRestraint = Field<CabinSeatRow4Pos5HeadRestraint?, NoArguments>("headRestraint")
    ...
    public var lumbar = Field<CabinSeatRow4Pos5Lumbar?, NoArguments>("lumbar")
    ...
    public var sideBolster = Field<CabinSeatRow4Pos5SideBolster?, NoArguments>("sideBolster")

    public var `switch` = Field<CabinSeatRow4Pos5Switch?, NoArguments>("switch")
